...
const CHANGELOG = [
    ...
    [
        'version' => '2.10.13',
        'date' => '2026-09-14',
        'title' => 'Scanner : la photo de l\'étiquette manquait aussi à l\'ajout',
        'items' => [
            "Suite au correctif de la v2.10.12 : la photo prise/recadrée lors du scan n'était toujours pas reprise par « Ajouter à ma cave », il fallait la réuploader à la main. Elle est maintenant copiée automatiquement vers la fiche du vin ajouté (avec un aperçu et la possibilité de la remplacer avant d'enregistrer si besoin).",
            "Rattrapage ponctuel : le Château Dorléac ajouté juste avant ce correctif a reçu sa photo rétroactivement.",
        ],
    ],
    [
        'version' => '2.10.12',
    ...
    [
        'version' => '2.10.4',
        'date' => '2026-09-14',
        'title' => '« À boire maintenant » redéfini : fenêtre en cours ou dépassée',
        'items' => [
            "Précision apportée sur les définitions : « à son apogée » reste le vin au sommet de sa qualité gustative, mais « à boire maintenant » doit couvrir tout vin déjà dans sa fenêtre de dégustation OU l'ayant dépassée — pas seulement les vins en retard.",
            "L'onglet « À boire maintenant » regroupe donc désormais à son apogée + à boire bientôt + apogée dépassée, avec la colonne « Dégustation » affichée pour distinguer chaque cas au sein de cette liste. « À son apogée » et « À boire bientôt » restent des onglets à part, plus précis.",
            "La tuile « À surveiller » du haut de page continue de ne compter que ce qui presse vraiment (à boire bientôt + apogée dépassée), sans les vins tranquillement à leur apogée.",
        ],
    ],
    [
        'version' => '2.10.3',
    ...
    [
        'version' => '2.10.1',
        'date' => '2026-09-14',
        'title' => 'Recherche par nom : éviter la dérive vers un vin homonyme',
        'items' => [
            "Diagnostiqué depuis le journal : trois scans du même « Tournepique » en 3 minutes avaient donné trois profils différents — la photo avait correctement lu Cahors (Malbec), mais relancer la recherche sur ce seul nom avait fait dériver l'IA vers un « Château Tournepique » bien réel mais totalement différent, en Pécharmant.",
            "Quand une recherche par nom porte sur le même vin qu'une identification précédente plus fiable (ex. une photo), l'appellation déjà connue est désormais transmise à l'IA comme repère — elle ne part plus d'une feuille blanche et reste sur le bon vin. Reproduit et vérifié : sans ce repère l'IA dérivait vers Pécharmant, avec elle reste sur Cahors.",
            "Les écarts de prix et de potentiel de garde d'un appel à l'autre, eux, resteront possibles sur un vin peu documenté : ce sont des estimations généralistes de l'IA, pas une donnée réelle — c'est justement pour ça que la recherche de prix réel (Open Food Facts) existe.",
        ],
    ],
    [
        'version' => '2.10.0',
        'date' => '2026-09-14',
        'title' => 'Recadrage d\'étiquette : suggestion ajustable ou entièrement manuel',
        'items' => [
            "Le recadrage automatique et silencieux de l'étiquette (qui pouvait mal tomber, comme sur le Château d'Avrillé) est remplacé par un outil de recadrage interactif : à chaque photo choisie (ajout d'un vin, modification, remplacement depuis la fiche), un cadre s'affiche sur l'image — pré-positionné par l'IA quand elle trouve l'étiquette — et se déplace ou se redimensionne au doigt ou à la souris avant de valider.",
            "« Utiliser la photo entière » reste possible en un clic, pour ne pas recadrer du tout.",
            "Le recadrage se fait entièrement dans le navigateur : aucune photo n'est envoyée au serveur avant validation, seule la suggestion de cadrage l'est (sur une version réduite, sans jamais être enregistrée).",
            "Le recadrage automatique et silencieux est conservé uniquement pour le scanner en magasin, où la rapidité prime et la photo n'est qu'un aide-mémoire secondaire.",
        ],
    ],
    [
        'version' => '2.9.3',
    ...
    [
        ...
        'items' => [
            ...
            "Les 15 photos déjà présentes dans l'historique ont été recadrées rétroactivement, ainsi que les 9 étiquettes déjà enregistrées sur des vins de la cave (8 réussies, 1 laissée telle quelle faute de détection concluante).",
    ...
    [
        'version' => '2.9.0',
        'date' => '2026-09-13',
        'title' => 'Le scanner magasin cherche aussi un prix réel',
        'items' => [
            "Le scanner en magasin cherche désormais un prix réellement relevé (Open Food Facts) avant de se contenter du prix indicatif de l'IA : celle-ci ne sert plus qu'en dernier recours, comme sur la fiche d'un vin.",
            "Recherche par code-barres quand le scan en fournit un, sinon tentative par nom + producteur (moins fiable, mais élargit la couverture).",
            "En pratique la couverture reste faible sur le vin (base contributive, surtout grande distribution) : l'estimation IA reste affichée la plupart du temps, mais désormais étiquetée sans ambiguïté « aucun prix réel trouvé ».",
            "La fiche d'un vin sans code-barres enregistré peut maintenant, elle aussi, tenter une recherche par nom (auparavant il fallait d'abord saisir le code-barres à la main).",
        ],
    ],
    [
        'version' => '2.8.1',
