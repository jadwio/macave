<?php
// Mode magasin : synthèse d'un vin à partir d'une photo d'étiquette.
// Rien n'est enregistré en cave, comme pour la recherche par nom.
...
// Type déterminé d'après le contenu réel, pas l'extension annoncée
...
echo json_encode(wine_info_from_photo($base64, $mime));
